...
export const childProperties: Readonly<Partial<Record<SyntaxKind, readonly (string | undefined)[]>>> = {
    ...
    [SyntaxKind.JSDocExportTag]: ["tagName", "exportClause", "moduleSpecifier", "attributes", "comment"],
    ...
    [SyntaxKind.JSExportDeclaration]: ["modifiers", "exportClause", "moduleSpecifier", "attributes"],
